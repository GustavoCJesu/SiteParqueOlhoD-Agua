...
export default function Formulario() {
    ...
    return (
        <section className="flex text-[#525252] bg-[#F2F2F2] p-10 mt-5 flex-wrap">
            <div className="w-full md:w-1/2 flex flex-col items-center">
                <div className='flex flex-col'>
                    ...
                    <div className="flex flex-col">
                        <div className={`flex justify-center items-center ${style.cardContact}`}>
                            <MapPin className="bg-[#028F9233] rounded-full overflow-visible p-3 text-[14494A] w-20 h-20 mr-3 text-[#14494A]" />
                            <div className="">
                                <h1 className="text-[30px]">Endereço</h1>
                                <p>
                                    Av. das Nascentes, 1000 <br />
                                    Bairro Ecológico, Cidade - UF
                                </p>
                            </div>
                        </div>
                        <div className={`flex justify-center items-center ${style.cardContact}`}>
                            <Phone className="bg-[#028F9233] rounded-full overflow-visible p-3 text-[14494A] w-20 h-20 mr-3 text-[#14494A]" />
                            <div className="">
                                <h1 className="text-[30px]">Telefone</h1>
                                <p>
                                    +55 (00) 1234-5678<br />
                                    +55 (00) 98765-4321
                                </p>
                        ...
                        <div className={`flex justify-center items-center ${style.cardContact}`}>
                            <Mail className="bg-[#028F9233] rounded-full overflow-visible p-3 text-[14494A] w-20 h-20 mr-3 text-[#14494A]" />
                            <div className="">
                                <h1 className="text-[30px]">Email</h1>
                                <p>
                        ...
                        <div className='flex items-center'>
                            <h1 className='text-[20px] mr-3'>Siga-nos: </h1>
                            <div>
                                <svg className={`${style.iconSocialMedia}`} width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full md:w-1/2 flex justify-center flex-col items-center">
                <h2 className='text-[40px] text-[#525252]'>
                    Envie uma mensagem
                </h2>
                <div>
                    <form className='flex flex-col items-center'>
                        <label className='text-[20px] self-start'>Nome Completo:</label>
                        <input
                            className={`${style.inpForm} bg-[#fff]` }
                            type="text"
                            placeholder="Nome..."
                            value={name}
                        ...
                        <label className='text-[20px] self-start mt-5'>Email:</label>
                        <input
                            className={`${style.inpForm} bg-[#fff]`}
                            type="text"
                            placeholder="Email..."
                        ...
                        />
                        <label className='text-[20px] self-start mt-5'>Assunto:</label>
                        <textarea className={`${style.message} bg-[#fff]`}>

                        </textarea>
                        <button className={`py-3 px-1 my-5 bg-gradient-to-r from-[#14494A] to-[#028F92] w-50 text-[#fff] rounded ${style.buttonForm}`} type='submit'>
                            Enviar
                        </button>
                    </form>
                </div>
