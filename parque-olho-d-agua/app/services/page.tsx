        ...
        <section className={style.service}>
            ...
            <div className='flex justify-around flex-wrap'>
                <div className='flex flex-col justify-center items-center'>
                    <Image src='/img/icon/GarfoFaca.svg' alt='Garoto' width={80} height={80} />
                    <p className='text-2xl'>
                        R$49,90 à vontade
                    </p>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <Image src='/img/icon/Crianca.svg' alt='Garfo e Faca' width={90} height={80} />
                    <p className='text-2xl'>
                        Até 10 anos: Meia
                    </p>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <Image src='/img/icon/Moeda.svg' alt='Garoto' width={80} height={80} />
                    <p className='text-2xl'>
                        Até 6 anos: Não paga
                    </p>
                </div>
                <div className='flex flex-col justify-center items-center'>
                    <Image src='/img/icon/chapeu.svg' alt='Garoto' width={80} height={80} />
                    <p className='text-2xl'>
