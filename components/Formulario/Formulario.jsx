            ...
            <div className="w-full md:w-1/2 flex justify-center flex-col items-center">
                ...
                <div className="w-full max-w-md px-4 md:px-0">
                    <form className='flex flex-col items-center'>
                        ...
                        <input
                            className={`${style.inpForm} bg-white w-full`}
                            type="text"
                            placeholder="Nome..."
                            value={name}
                            onChange={(e) => setName(e.target.value)}
                        />
                        <label className='text-base md:text-[20px] self-start mt-4 md:mt-5'>Email:</label>
                        <input
                            className={`${style.inpForm} bg-white w-full`}
                            type="text"
                            placeholder="Email..."
                        ...
                        />
                        <label className='text-base md:text-[20px] self-start mt-4 md:mt-5'>Assunto:</label>
                        <textarea className={`${style.message} bg-white w-full`} />
                        <button
