  ...
  return (
    <footer className='flex flex-col md:flex-row'>
      <div className={`w-full md:w-1/2 flex justify-center items-center flex-col text-center ${styles.leftFooter}`}>
        ...
        <div className='flex'>
          <Link href='https://www.facebook.com/share/17jDbrbBBV/?mibextid=wwXIfr' target='_blank' className={styles.socialIcon}>
          ...
          <Link href='https://wa.me/5535999322462' target='_blank' className={styles.socialIcon}>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" className='w-8 h-8 md:w-10 md:h-10' viewBox="0 0 24 24">
          ...
          <Link href='https://www.instagram.com/parqueecologicoolhodagua' target='_blank' className={styles.socialIcon}>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" className='w-8 h-8 md:w-10 md:h-10' viewBox="0 0 24 24">
